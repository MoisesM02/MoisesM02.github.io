...
<?php include "includes/menu.php"?>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <input class="mt-4 " type="checkbox" id="disponibles"><label for="disponibles" class="pl-2"> Disponibles</label>
        </div>
        <div class="col-md-3">
     ...
     <div class="col-md-2">
     <button class="btn btn-warning my-3" id="showModal">Agregar Entrada</button>
     </div>
    </div>
