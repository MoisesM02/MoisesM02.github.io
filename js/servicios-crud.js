$(document).ready(function(){
    ...
    let search = false
    crearTabla(1,10);
    $('#waiting-container').bind('ajaxStart', function(){
        $(this).show();
    ...
    $('#precioServicio').on('change',function(){
        ...
        $('#porcentajeEmpleado').val(0)
        $('#porcentajeCasa').val(0);
    }) 
    ...
    $('#gananciaCasa').on('change', function(){
        ...
        $('#porcentajeCasa').val(((gananciaCasa*100)/precio).toFixed(2));
            ...
            $('#gananciaCasa').val("0")
            Swal.fire('No se puede tener una ganancia mayor al precio total del servicio', '', 'error');
